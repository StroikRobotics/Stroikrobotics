...
En esta sección se documenta el proceso experimental y de validación del robot. Las pruebas están organizadas de forma cronológica según la madurez del proyecto, partiendo desde los subsistemas mecánicos aislados hasta las pruebas de navegación autónoma y evasión de obstáculos.
...
| Prueba / Mecanismo | Descripción Técnica | Demostración (Enlace) |
| :--- | :--- | :---: |
...
| Prueba / Comportamiento | Descripción Técnica | Demostración (Enlace) |
| :--- | :--- | :---: |
| **03. Evasión de Obstáculos Dinámicos** | El robot ejecuta una rutina de búsqueda en área abierta con el chasis integrado. El algoritmo calcula la proximidad de un objeto esférico (pelota roja) mediante sensores ultrasónicos/distancia, variando su trayectoria y frenado en función del movimiento dinámico del objeto. | [▶️ Ver Video de Navegación](ENLACE_AL_VIDEO_3) |
